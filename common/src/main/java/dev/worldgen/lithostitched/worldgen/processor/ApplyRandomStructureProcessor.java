...
public class ApplyRandomStructureProcessor extends StructureProcessor {
    private static final Codec<WeightedList<Holder<StructureProcessorList>>> WEIGHTED_LIST_CODEC = WeightedList.wrappedCodecAllowingEmpty(StructureProcessorType.LIST_CODEC);
    ...
    private static HolderSet<StructureProcessorList> convertToSet(WeightedList<Holder<StructureProcessorList>> weightedList) {
        ...
        for (Weighted.Wrapper<Holder<StructureProcessorList>> processor : weightedList.unwrap()) {
