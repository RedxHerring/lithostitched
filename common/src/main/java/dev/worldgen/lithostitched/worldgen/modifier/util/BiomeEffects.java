...
public record BiomeEffects(Optional<Integer> fogColor, Optional<Integer> waterColor, Optional<Integer> waterFogColor, Optional<Integer> skyColor, Optional<Integer> foliageColor, Optional<Integer> grassColor, Optional<BiomeSpecialEffects.GrassColorModifier> grassColorModifier, Optional<AmbientParticleSettings> ambientParticle, Optional<Holder<SoundEvent>> ambientSound, Optional<AmbientMoodSettings> moodSound, Optional<AmbientAdditionsSettings> additionsSound, Optional<WeightedList<Music>> music, Optional<Float> musicVolume) {
    public static final Codec<BiomeEffects> CODEC = RecordCodecBuilder.create(instance -> instance.group(
        ...
        LithostitchedCodecs.singleOrWeightedList(Music.CODEC, true).optionalFieldOf("music").forGetter(BiomeEffects::music),
        Codec.floatRange(0f, 1f).optionalFieldOf("music_volume").forGetter(BiomeEffects::musicVolume)
